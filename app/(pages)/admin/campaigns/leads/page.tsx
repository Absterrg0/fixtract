...
type Lead = { _id: string; email: string; firstName?: string; lastName?: string; country: string; locale: string; serviceKeys?: string[]; status: "active" | "deleted"; createdAt?: string; updatedAt?: string; matchedSubscriber?: boolean; matchedSubscriberId?: string; suppressed?: boolean; suppressionReason?: string; unsubscribedAt?: string | null };
