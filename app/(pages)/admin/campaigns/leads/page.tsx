...
type ImportRecord = { _id: string; filename: string; status: string; totalRows: number; validRows: number; insertedRows: number; updatedRows: number; duplicateRows: number; rejectedRows: number; errors?: { row: number; field?: string; message: string }[]; uploadedAt?: string; committedAt?: string };
type Validation = { headers?: string[]; totalRows: number; validRows: number; duplicateRows: number; rejectedRows: number; errors?: { row: number; field?: string; message: string }[]; rows?: { rowNumber: number; email: string; country: string; locale: string; serviceKeys: string[] }[] };
